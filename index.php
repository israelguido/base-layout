...
<head>
    ...
    <meta name="description"
          content="O que é Marketing Digital? Promover produtos ou marcas através das mídias digitais é a principal definição para o Marketing Digital."/>
                    ...
                    <ul class="submenu megamenu">
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="index-travel.html">Travel <span
                                                class="badge badge-danger rounded">v2.5</span></a></li>
                                <li><a href="index-blog.html">Blog <span class="badge badge-danger rounded">v2.5</span></a>
                                </li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="index-onepage.html">Saas <span class="badge badge-pill badge-warning ml-2">Onepage</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-submenu"><a href="javascript:void(0)"> Account <span
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="account-works.html">Works <span
                                                class="badge badge-success rounded">New</span></a></li>
                                <li><a href="account-messages.html">Messages <span class="badge badge-success rounded">New</span></a>
                                </li>
                                <li><a href="account-payments.html">Payments <span class="badge badge-success rounded">New</span></a>
                                </li>
                        ...
                        <li class="has-submenu"><a href="javascript:void(0)"> Forums <span
                                    ...
                                    class="submenu-arrow"></span>
                            <ul class="submenu">
                                <li><a href="forums.html">Overview <span class="badge badge-success rounded">New</span></a>
                                </li>
                                <li><a href="forums-topic.html">Forum Topic <span class="badge badge-success rounded">New</span></a>
                                </li>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7 order-1 order-md-2">
                <div class="title-heading mt-4 ml-lg-5">
                    <h1 class="heading mb-3">Criados para o Marketing Digital <span class="text-primary">Publinet</span>
                    </h1>
                    <p class="para-desc text-muted">Lance sua campanha e aproveite nossa expertise em criar e gerenciar
                        páginas otimizadas e focadas em conversão para marketing digital.</p>
                    <div class="watch-video mt-4 pt-2">
                        <a href="javascript:void(0)" class="btn btn-primary">Saiba Mais <i
                                    class="mdi mdi-chevron-right"></i></a>
                        <a href="https://www.youtube.com/watch?v=qcMITRKVJy8"
            ...
            <div class="col-md-4 col-12">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        ...
                        <p class="text-muted mb-0">Crie seu site com nossa equipe especializada em design e
                            desenvolvimento de páginas responsivas e focadas na experiência do usuário.</p>
                    </div>
                </div>
            </div><!--end col-->
            ...
            <div class="col-md-4 col-12 mt-5 mt-sm-0">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        ...
                        <p class="text-muted mb-0">Gerencie sua marca com nossa expertise em estratégias de marketing
                            digital e gestão de conteúdo de alta qualidade.</p>
                    </div>
                </div>
            </div><!--end col-->
            ...
            <div class="col-md-4 col-12 mt-5 mt-sm-0">
                <div class="features text-center">
                    ...
                    <div class="content mt-4">
                        ...
                        <p class="text-muted mb-0">Desenvolva estratégias eficazes com nossa expertise em pesquisa de
                            mercado e análise de dados para alcançar seus objetivos.</p>
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div class="section-title ml-lg-3">
                    ...
                    <p class="text-muted">Resolvemos problemas de marketing e análise no Google Ads identificando e
                        corrigindo padrões ineficazes, otimizando campanhas e ajustando estratégias com base em dados
                        precisos para maximizar o impacto e melhorar o desempenho.</p>
                    <a href="javascript:void(0)" class="mt-3 h6 text-primary">Quero Saber Mais Sobre Isso <i
                                class="mdi mdi-chevron-right"></i></a>
                </div>
            </div><!--end col-->
        </div><!--end row-->
            ...
            <div class="col-12 text-center">
                <div class="section-title mb-4 pb-2">
                    ...
                    <p class="text-muted para-desc mx-auto mb-0">Comece a trabalhar com <span
                                class="text-primary font-weight-bold">Publinet</span> e descubra como nossa expertise em
                        marketing digital pode transformar sua presença online, aumentar seu alcance e maximizar seus
                        resultados.</p>
                </div>
            </div><!--end col-->
