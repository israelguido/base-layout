                    ...
                    <div class="col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="ml-lg-4">
                            <div class="d-flex mb-4">
                                <span class="text-primary h1 mb-0"><span class="counter-value display-1 font-weight-bold" data-count="15">16</span>+</span>
                                <span class="h6 align-self-end ml-2">Anos <br> de Experiência</span>
                            </div>
                            <div class="section-title">
                                <h4 class="title mb-4">Quem Somos?</h4>
                                <p class="text-secondary">A agência de marketing digital Publinet, uma empresa com 16 anos de mercado focada em resultados no mundo do marketing digital.</p>
                                <p class="text-secondary">Entre nossos serviços o principal é SEO nossa meta sempre é que todos nossos clientes estejam muito bem posicionados na 1ª pagina do Google de forma orgânica em suas principais palavras chave.</p>
                                <p class="text-secondary">A Agência de Marketing Digital Publinet oferece diversos serviços de marketing digital para diversos segmentos de mercado somos especialistas em marketing digital para industrias, empresas e comércios.</p>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                                <div class="card shop-list border-0 position-relative overflow-hidden">
                                    <div class="shop-image position-relative overflow-hidden rounded shadow">
                                        <a href="shop-product-detail.html"><img src="images/publinet-img.png" class="img-fluid" alt=""></a>
